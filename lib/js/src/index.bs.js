...
function Index$Components$TooDoo(Props) {
...
var TooDoo = /* module */[/* make */Index$Components$TooDoo];
...
ReactDOMRe.renderToElementWithId(React.createElement(Index$Components$TooDoo, { }), "app");
